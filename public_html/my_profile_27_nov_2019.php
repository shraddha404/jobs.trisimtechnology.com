                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-md-1"><input type="button" class="btn btn-info btn-xs btnShowBasicDetails" data-toggle="modal"  value="Edit" id="<?php echo $userdetails[0]['id']; ?>"
                                                                                         data-target="#modalFormBasicDetails"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="profile-box-white">
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="col-md-12"><h3><b>Resume Headline</b>&nbsp;&nbsp;<?php if (!empty($resumeheadline[0]['resume_headline'])) { ?><input style="float: right;"type="button" name="edit" value="Edit" id="<?php echo $resumeheadline[0]['user_id']; ?>" class="btn btn-info btn-xs edit_headline" /><?php } ?>    <br/><br/></h3>
                                    ...
                                    <div class="profile-box-white">
                                        ...
                                        <div class="row">
                                            <?php foreach ($employmentdetails as $employmentdetail) { ?>
                                                ...
                                                <div class="col-md-2"><input type="button" name="edit" value="Edit" id="<?php echo $employmentdetail['id']; ?>" class="btn btn-info btn-xs edit_employment" /><br/><br/></div>
                                            <?php } ?>
                                    ...
                                    <div class="profile-box-white">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php foreach ($userskills as $userskill) { 
                                                ...
                                                <div class="col-md-2">	<input type="button" name="edit" value="Edit" id="<?php echo $userskill['id']; ?>" user_id="<?php echo $_SESSION['user_id']; ?>" class="btn btn-info btn-xs edit_skill" /><br/></div>                                               
