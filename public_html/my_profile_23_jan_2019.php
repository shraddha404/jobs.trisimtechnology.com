...
if($pageRefreshed == 2){
    $id=$_SESSION['user_id'];
            $config = $u->getConfig();
          $adminEmail= $u->getUserAdminEmail();
      $userdetails = $u->getUserDetails($_SESSION['user_id']);
      $name=   $userdetails[0]['first_name'];
      
      if(empty($name)){ $name=   $userdetails[0]['username'];}
      if($userdetails[0]['gender']=="Male"){$g="his";}else{$g="her";}
				$message = "
				Hello Admin,<br /><br />
				$name have updated $g profile.
				<br /><br />
				Click on the following link to view candidates updated profile.
				<br /><br />
				<a href='http://" . $config["http_host"] . "/candidate_profile_view.php?id=$id'>click here to view candidates updated profile.</a>
				<br /><br />
				Thank you :)<br /><br />
				Regards,<br />
				Team Trisim Technology";
				//echo $message;
				$subject = "Candidate Upadated Profile ";
				if ($u->sendSMTPEmail($adminEmail,$adminEmail, $subject,$message)) {
				//echo "sent";
				} else {
				//echo "Not sent";
				}
...
?> 
<script>
function clickMeEditEducation(e){
	jQuery.noConflict();
	myElementValue = e;
var pausecontent = <?php echo json_encode($education); ?>;
alert(e);
//if select 12th	   
if((myElementValue=='12th') && (pausecontent['10th'].length === 0)){
alert('Please First fill 10th details'); 
$("#12th_spcl").prop( "disabled", true );    
$("#12th_school").prop( "disabled", true );           
$("#12th_university").prop( "disabled", true );           
$("#12th_percentage").prop( "disabled", true );           
$("#12th_marks").prop( "disabled", true );           
$("#12th_physics_marks").prop( "disabled", true );           
$("#12th_chemistry_marks").prop( "disabled", true );           
$("#12th_maths_marks").prop( "disabled", true );           
$("#12th_Pyear").prop( "disabled", true );           
       

 $('#education_select"').focus();       
return false;
}else if((myElementValue=='btech') && (pausecontent['10th'].length === 0) && (pausecontent['12th'].length === 0)){
alert('Please First fill 10th 12th details');
$("#btech_spcl").prop( "disabled", true );    
$("#btech_school").prop( "disabled", true );           
$("#btech_university").prop( "disabled", true );           
$("#btech_percentage").prop( "disabled", true );           
$("#btech_marks").prop( "disabled", true );                     
$("#btech_Pyear").prop( "disabled", true );
$('#education_select"').focus(); 
return false;
}else if((myElementValue=='btech') && (pausecontent['10th'].length === 0)){
alert('Please First fill  12th details');
$("#btech_spcl").prop( "disabled", true );    
$("#btech_school").prop( "disabled", true );           
$("#btech_university").prop( "disabled", true );           
$("#btech_percentage").prop( "disabled", true );           
...
$('#education_select"').focus(); 
return false;
}else if((myElementValue=='btech') &&  (pausecontent['12th'].length === 0)){
alert('Please First fill 12th  details');
$("#btech_spcl").prop( "disabled", true );    
$("#btech_school").prop( "disabled", true );           
$("#btech_university").prop( "disabled", true );           
...
$('#education_select"').focus(); 
return false;
}else if((myElementValue=='be') && (pausecontent['10th'].length === 0) && (pausecontent['12th'].length === 0)){
alert('Please First fill 10th 12th details');
$("#be_spcl").prop( "disabled", true );    
$("#be_school").prop( "disabled", true );           
$("#be_university").prop( "disabled", true );           
$("#be_percentage").prop( "disabled", true );           
$("#be_marks").prop( "disabled", true );                     
$("#be_Pyear").prop( "disabled", true );
$('#education_select"').focus(); 
return false;
}else if((myElementValue=='be') && (pausecontent['10th'].length === 0)){
alert('Please First fill  12th details');
$("#be_spcl").prop( "disabled", true );    
$("#be_school").prop( "disabled", true );           
$("#be_university").prop( "disabled", true );           
...
$('#education_select"').focus(); 
return false;
}else if((myElementValue=='be') &&  (pausecontent['12th'].length === 0)){
alert('Please First fill 12th  details');
$("#be_spcl").prop( "disabled", true );    
$("#be_school").prop( "disabled", true );           
$("#be_university").prop( "disabled", true );           
...
$('#education_select"').focus(); 
return false;
}else if((myElementValue=='me') && (pausecontent['10th'].length === 0) && (pausecontent['12th'].length === 0) && (pausecontent['be'].length === 0)  ){
alert('Please First fill 10th 12th BE details');
$("#me_spcl").prop( "disabled", true );    
$("#me_school").prop( "disabled", true );           
$("#me_university").prop( "disabled", true );           
$("#me_percentage").prop( "disabled", true );           
$("#me_marks").prop( "disabled", true );                     
$("#me_Pyear").prop( "disabled", true ); 
$('#education_select"').focus();
return false;
}else if((myElementValue=='me') && (pausecontent['10th'].length === 0) && (pausecontent['12th'].length === 0)){
alert('Please First fill 10th 12th details');
$("#me_spcl").prop( "disabled", true );    
$("#me_school").prop( "disabled", true );           
$("#me_university").prop( "disabled", true );           
...
$('#education_select"').focus();
return false;
}else if((myElementValue=='me') &&  (pausecontent['12th'].length === 0) && (pausecontent['BE'].length === 0)){
alert('Please First fill 12th BE details');
$("#me_spcl").prop( "disabled", true );    
$("#me_school").prop( "disabled", true );           
$("#me_university").prop( "disabled", true );           
$("#me_percentage").prop( "disabled", true );           
...
$('#education_select"').focus();
return false;
}else if((myElementValue=='me') &&  (pausecontent['10th'].length === 0) ){
alert('Please First fill 10th details');
$("#me_spcl").prop( "disabled", true );    
$("#me_school").prop( "disabled", true );           
$("#me_university").prop( "disabled", true );           
...
$('#education_select"').focus();
return false;
}else if((myElementValue=='me') &&  (pausecontent['12th'].length === 0) ){
alert('Please First fill 12th  details');
$("#me_spcl").prop( "disabled", true );    
$("#me_school").prop( "disabled", true );           
$("#me_university").prop( "disabled", true );           
...
$('#education_select"').focus();
return false;
}else if((myElementValue=='mtech') && (pausecontent['10th'].length === 0) && (pausecontent['12th'].length === 0) && (pausecontent['BE'].length === 0)){
alert('Please First fill 10th 12th BE details');
$("#mtech_spcl").prop( "disabled", true );    
$("#mtech_school").prop( "disabled", true );           
$("#mtech_university").prop( "disabled", true );           
$("#mtech_percentage").prop( "disabled", true );           
$("#mtech_marks").prop( "disabled", true );                     
$("#mtech_Pyear").prop( "disabled", true ); 
$('#education_select"').focus();
return false;

}else if((myElementValue=='mtech') && (pausecontent['10th'].length === 0) && (pausecontent['12th'].length === 0)){
alert('Please First fill 10th 12th details');
$("#mtech_spcl").prop( "disabled", true );    
$("#mtech_school").prop( "disabled", true );           
$("#mtech_university").prop( "disabled", true );           
...
$('#education_select"').focus();
return false;
}else if((myElementValue=='mtech') &&  (pausecontent['12th'].length === 0) && (pausecontent['BE'].length === 0)){
alert('Please First fill 12th BE details');
$("#mtech_spcl").prop( "disabled", true );    
$("#mtech_school").prop( "disabled", true );           
$("#mtech_university").prop( "disabled", true );           
...
$('#education_select"').focus();
return false;
}else if((myElementValue=='mtech') &&  (pausecontent['10th'].length === 0) && (pausecontent['BE'].length === 0)){
alert('Please First fill 10th BE details');
$("#mtech_spcl").prop( "disabled", true );    
$("#mtech_school").prop( "disabled", true );           
$("#mtech_university").prop( "disabled", true );           
$("#mtech_percentage").prop( "disabled", true );           
...
}else if((myElementValue=='mtech') &&  (pausecontent['12th'].length === 0) ){
alert('Please First fill 12th details');
$("#mtech_spcl").prop( "disabled", true );    
$("#mtech_school").prop( "disabled", true );           
$("#mtech_university").prop( "disabled", true );           
...
}else if((myElementValue=='mtech') &&  (pausecontent['BE'].length === 0) ){
alert('Please First fill BE details');
$("#mtech_spcl").prop( "disabled", true );    
$("#mtech_school").prop( "disabled", true );           
$("#mtech_university").prop( "disabled", true );           
$("#mtech_percentage").prop( "disabled", true );           
...
else if((myElementValue=='mtech') &&  (pausecontent['10th'].length === 0) ){
alert('Please First fill 10th details');
$("#mtech_spcl").prop( "disabled", true );    
$("#mtech_school").prop( "disabled", true );           
$("#mtech_university").prop( "disabled", true );           
...
}else if((myElementValue=='phd') && (pausecontent['10th'].length === 0) && (pausecontent['12th'].length === 0) && (pausecontent['BE'].length === 0)){
alert('Please First fill 10th 12th BE details');
$("#phd_spcl").prop( "disabled", true );    
$("#phd_school").prop( "disabled", true );           
$("#phd_university").prop( "disabled", true );           
$("#phd_percentage").prop( "disabled", true );           
$("#phd_marks").prop( "disabled", true );                     
$("#phd_Pyear").prop( "disabled", true ); 
$('#education_select"').focus();
return false;
}else if((myElementValue=='phd') && (pausecontent['10th'].length === 0) && (pausecontent['12th'].length === 0)){
alert('Please First fill 10th 12th details');
$("#phd_spcl").prop( "disabled", true );    
$("#phd_school").prop( "disabled", true );           
$("#phd_university").prop( "disabled", true );           
...
$('#education_select"').focus();
return false;
}else if((myElementValue=='phd') &&  (pausecontent['10th'].length === 0) ){
alert('Please First fill 10th details');
$("#phd_spcl").prop( "disabled", true );    
$("#phd_school").prop( "disabled", true );           
$("#phd_university").prop( "disabled", true );           
...
$('#education_select"').focus();
return false;
}else if((myElementValue=='phd') &&  (pausecontent['12th'].length === 0) ){
alert('Please First fill 12th details');
$("#phd_spcl").prop( "disabled", true );    
$("#phd_school").prop( "disabled", true );           
$("#phd_university").prop( "disabled", true );           
...
$("#12th_Pyear").prop( "disabled", true );           
 ...
 $('#education_select"').focus();
}else if((myElementValue=='M.Tech') && (pausecontent['10th'].length === 0) && (pausecontent['12th'].length === 0) && (pausecontent['BE'].length === 0)){
alert('Please First fill 10th 12th BE details');
$("#mtech_spcl").prop( "disabled", true );    
$("#mtech_school").prop( "disabled", true );           
$("#mtech_university").prop( "disabled", true );           
...
}else if((myElementValue=='M.Tech') && (pausecontent['10th'].length === 0) && (pausecontent['12th'].length === 0)){
alert('Please First fill 10th 12th details');
$("#mtech_spcl").prop( "disabled", true );    
$("#mtech_school").prop( "disabled", true );           
$("#mtech_university").prop( "disabled", true );           
...
$('#education_select"').focus();
return false;
}else if((myElementValue=='M.Tech') &&  (pausecontent['12th'].length === 0) && (pausecontent['BE'].length === 0)){
alert('Please First fill 12th BE details');
$("#mtech_spcl").prop( "disabled", true );    
$("#mtech_school").prop( "disabled", true );           
$("#mtech_university").prop( "disabled", true );           
...
}else if((myElementValue=='B.Tech') && (pausecontent['10th'].length === 0) && (pausecontent['12th'].length === 0) && (pausecontent['BE'].length === 0)){
alert('Please First fill 10th 12th BE details');
$("#btech_spcl").prop( "disabled", true );    
$("#btech_school").prop( "disabled", true );           
$("#btech_university").prop( "disabled", true );           
...
}else if((myElementValue=='B.Tech') && (pausecontent['10th'].length === 0) && (pausecontent['12th'].length === 0)){
alert('Please First fill 10th 12th details');
$("#btech_spcl").prop( "disabled", true );    
$("#btech_school").prop( "disabled", true );           
$("#btech_university").prop( "disabled", true );           
...
$("#btech_Pyear").prop( "disabled", true ); 
$('#education_select"').focus();
}else if((myElementValue=='B.Tech') &&  (pausecontent['12th'].length === 0) && (pausecontent['BE'].length === 0)){
alert('Please First fill 12th BE details');
$("#btech_spcl").prop( "disabled", true );    
$("#btech_school").prop( "disabled", true );           
$("#btech_university").prop( "disabled", true );           
...
$("#phd_Pyear").prop( "disabled", true ); 
$('#education_select"').focus();
}else if((myElementValue=='PhD') &&  (pausecontent['12th'].length === 0) && (pausecontent['BE'].length === 0)){
alert('Please First fill 12th BE details');
$("#phd_spcl").prop( "disabled", true );    
$("#phd_school").prop( "disabled", true );           
$("#phd_university").prop( "disabled", true );           
...
<div class="container">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-md-1"><?php if ($_SESSION['user_type']!= 'Admin'){?><input type="button" class="btn btn-info btn-xs btnShowBasicDetails" data-toggle="modal"  value="Edit" id="<?php echo $userdetails[0]['id']; ?>"
                                    ...
                                    <div class="profile-box-white">
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="col-md-6" align="right"><?php if (!empty($resumeheadline[0]['resume_headline'])) {  if ($_SESSION['user_type']!= 'Admin'){?>
													<input style="float: right;"type="button" name="edit" value="Edit" id="<?php echo $resumeheadline[0]['user_id']; ?>" class="btn btn-info btn-xs edit_headline" />
													<?php }  }?> <?php if ($_SESSION['user_type']!= 'Admin'){?>
                                                    <!-- Button to trigger modal --><?php if (empty($resumeheadline[0]['resume_headline'])) { ?>
                                                        <button class="btn2 btn-2 btn2-1b" data-toggle="modal"  id="btnShowResumeHeadline"
                                                                data-target="#modalFormResumeHeadline">Resume Headline</button>
                                                            <?php } ?> <?php } ?>     
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="profile-box-white">
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="col-md-6" align="right">
                                                    ...
                                                    <?php if (!$_GET['id']) { ?>
                                                        <button class="btn2 btn-2 btn2-1b" data-toggle="modal"  id="btnShow"
                                                                data-target="#modalFormAddEmployment">Add Employment</button>
                                                            <?php } ?>
                                        ...
                                        <div class="row">
                                            <?php foreach ($employmentdetails as $employmentdetail) { ?>
                                                ...
                                                <div class="col-md-2"><?php if ($_SESSION['user_type']!= 'Admin'){?><input type="button" name="edit" value="Edit" id="<?php echo $employmentdetail['id']; ?>" class="btn btn-info btn-xs edit_employment" /><br/><br/><?php } ?></div>
                                            <?php  }?>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="col-md-6" align="right">
                                                    <!-- Button to trigger modal -->
                                                    <?php if (!$_GET['id']) { ?>
                                                        <button class="btn2 btn-2 btn2-1b" data-toggle="modal"  id="btnShowEducation"
                                                                data-target="#modalFormAddEducation" >Add Education</button>
                                                            <?php } ?>
 ...
 <div class="col-md-6" align="right">
                                                    <!-- Button to trigger modal --><?php  if($_SESSION['user_type']!='Admin'){if ($gate_edit == 'show') { ?>
                                    ...
                                    <div class="profile-box-white">
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="col-md-6" align="right">
                                                    <!-- Button to trigger modal -->
                                                    <?php if (!$_GET['id']) { ?>
                                                        <button class="btn2 btn-2 btn2-1b" data-toggle="modal"  id="btnShowSkills"
                                                                data-target="#modalFormAddSkill">ADD SKILLS and TOOLS</button>
                                                            <?php } ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <?php foreach ($userskills as $userskill) { 
                                                ...
                                                <div class="col-md-2"><?php if ($_SESSION['user_type']!= 'Admin'){?><input type="button" name="edit" value="Edit" id="<?php echo $userskill['id']; ?>" user_id="<?php echo $_SESSION['user_id']; ?>" class="btn btn-info btn-xs edit_skill" /><br/> <?php } ?>
</div>                                               
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="col-md-6" align="right">
                                                    ...
                                                    <?php foreach ($userdetails as $userdetail) { ?>
                                                        <?php if (empty($userdetail['date_of_birth'])) {  if($_SESSION['user_type']!='Admin'){?>
                                        ...
                                        <div class="row">
                                            ...
                                            <?php foreach ($userdetails as $userdetail) { ?>
                                                ...
                                                <?php if (!empty($userdetail['date_of_birth'])) { ?>
                                                    <div class="col-md-2">	<?php if ($_SESSION['user_type']!= 'Admin'){?><input type="button" name="edit" value="Edit" id="<?php echo $userdetail['id']; ?>" class="btn btn-info btn-xs edit_personal" /><br/><?php } ?></div>
                                                    <?php
                                                }
                                            }
                                            ?>
                            ...
                            <div class="row"  id="Resume">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="profile-box-white">
                                        ...
                                        </div><?php if ($_SESSION['user_type']!= 'Admin'){?>
                                        <?php if($userdetails[0]['userType']=="User"){ ?>
                                        <div class="row">
                                            <input type="hidden" name="id" value="<?php echo $_SESSION['user_id']; ?>">

                                            <input type="file" path="resume_file" id="resume_file" name="resume_file" required>
                                                       <!--input type="hidden"  id="resumefile" name="resumefile" value="<?php echo $userdetail['resume_file_data']; ?>"-->
                                             <?php if($userdetail['resume_file_data']!=""){?>
                                       ...
                                       <br/><br/>
                                        <div class="row">
                                            ...
                                            <input type="submit" value="SUBMIT" id="submitresumefile" name="submitresumefile" class="btn btn-primary submitBtn" >
                                        </div>	 <?php }?><?php }?>
                                        </form>												
                                    </div>
                        ...
                        <form role="form" id="addEducation"  class="addEducation" method="post" action="my_profile.php">
                            ...
                            <div class="modal-body">
                                ...
                                <div id="select_edu_div" name="select_edu_div">
                                    ...
                                    <select name="education_select" id="education_select" class="form-control" onclick="clickMe(this)" required>      
                                    ...
                                    <div id="phd" name="phd">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail">Year of Passing<span class="mandatory">*
                                                                   ...
                                                                   id="phd_Pyear" name="phd_Pyear" placeholder="Type PhD Year of Passing"  required/>
                                        </div>
                                    </div></div>
